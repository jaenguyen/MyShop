...
public class DetailConfirmOrderMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCreatedTime.setText(String.valueOf(orderOutput.getCreatedTime()));
    ...
    private void init() {
        ...
        txtPhoneAddress = findViewById(R.id.txt_name_address);
        txtStreetAddress = findViewById(R.id.txt_name_address);
        txtName = findViewById(R.id.txt_name_address);
        txtPrice = findViewById(R.id.txt_name_address);
        txtQuantity = findViewById(R.id.txt_name_address);
        totalPrice = findViewById(R.id.txt_name_address);
        txtId = findViewById(R.id.txt_name_address);
        txtCreatedTime = findViewById(R.id.txt_name_address);
