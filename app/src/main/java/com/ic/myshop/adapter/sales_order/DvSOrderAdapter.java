...
import com.ic.myshop.activity.sales_order.DetailDeliverySOrderMainActivity;
...
public class DvSOrderAdapter extends RecyclerView.Adapter<DvSOrderAdapter.CfOrderViewHolder> {

    private Context context;
    private List<OrderOutput> orders;

    public DvSOrderAdapter(Context context) {
    ...
    public CfOrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_delivery_sales_order, parent, false);
    ...
    public void onBindViewHolder(@NonNull CfOrderViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailDeliverySOrderMainActivity.class);
